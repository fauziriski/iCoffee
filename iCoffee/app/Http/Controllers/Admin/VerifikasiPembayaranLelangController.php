...
class  VerifikasiPembayaranLelangController extends Controller
{
	...
	public function validasiOrderLelang(Request $request)
	{
		...
		$catatan = "Pembelian kopi lelang sebanyak ".$kg."Kg dengan total harga Rp.".number_format($total_bayar)." dan total ongkos kirim sebesar Rp.".number_format($total_ongkir);
