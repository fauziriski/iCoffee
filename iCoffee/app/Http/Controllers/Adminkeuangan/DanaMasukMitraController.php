...
class DanaMasukMitraController extends Controller
{
	public function danaMasuk(){
		...
		{	
			...
			->where('akt_jurnal.id_kat_jurnal',3)
		...
		return view('admin.admin-keuangan.dana-masuk-mitra',compact('tran','kategori','satu'));
	}
	...
	public function detailDanaMasuk($id)
	{
		...
		{	
			...
			// $data2 = Akt_akun::where('id_adm_jurnal',$id)->first();
