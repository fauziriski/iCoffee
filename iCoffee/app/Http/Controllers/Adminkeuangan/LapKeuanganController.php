...
class LapKeuanganController extends Controller
{
    ...
    function arusKas(){
        if(!empty($request->from_date))
        {
            ...
            return view('admin.admin-keuangan.arus-kas-update',compact('data1','data2','total_pendapatan','total_beban','laba','from_date','to_date'));
            ...
            $investasi = DB::table('akt_akun')
                ...
                return view('admin.admin-keuangan.arus-kas',compact('data1','data2','total_pendapatan','total_beban','laba','total_investasi','investasi','kas'));
            }
