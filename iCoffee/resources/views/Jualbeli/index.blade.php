...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="Jualbeli/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="Jualbeli/css/animate.css">
    
    <link rel="stylesheet" href="Jualbeli/css/owl.carousel.min.css">
    <link rel="stylesheet" href="Jualbeli/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="Jualbeli/css/magnific-popup.css">

    <link rel="stylesheet" href="Jualbeli/css/aos.css">

    <link rel="stylesheet" href="Jualbeli/css/ionicons.min.css">

    <link rel="stylesheet" href="Jualbeli/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="Jualbeli/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="Jualbeli/css/flaticon.css">
    <link rel="stylesheet" href="Jualbeli/css/icomoon.css">
    <link rel="stylesheet" href="Jualbeli/css/style.css">
  </head>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="lelang.html" class="nav-link">Lelang</a></li>
    ...
    <section class="ftco-section">
    	<div class="container">
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="product-single.html" class="img-prod"><img class="img-fluid" src="images/product-5.jpg" alt="Colorlib Template">
  ...
  <script src="Jualbeli/js/jquery.min.js"></script>
  <script src="Jualbeli/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="Jualbeli/js/popper.min.js"></script>
  <script src="Jualbeli/js/bootstrap.min.js"></script>
  <script src="Jualbeli/js/jquery.easing.1.3.js"></script>
  <script src="Jualbeli/js/jquery.waypoints.min.js"></script>
  <script src="Jualbeli/js/jquery.stellar.min.js"></script>
  <script src="Jualbeli/js/owl.carousel.min.js"></script>
  <script src="Jualbeli/js/jquery.magnific-popup.min.js"></script>
  <script src="Jualbeli/js/aos.js"></script>
  <script src="Jualbeli/js/jquery.animateNumber.min.js"></script>
  <script src="Jualbeli/js/bootstrap-datepicker.js"></script>
  <script src="Jualbeli/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="Jualbeli/js/google-map.js"></script>
  <script src="Jualbeli/js/main.js"></script>
