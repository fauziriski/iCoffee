      ...
      <li class="nav-item">
        ...
        <div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('validasi-pembayaran')}}">Data Customer</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('validasi-petani-lelang')}}">Validasi Petani</a>
            ...
            <a class="collapse-item" href="{{url('produk-lelang')}}">Produk Lelang</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Laporan :</h6>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePagess" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('validasi-petani-investasi')}}">Validasi Petani</a>
