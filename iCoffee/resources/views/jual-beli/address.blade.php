    ...
    <main class="col bg-faded py-1 border flex-grow-1 mt-2" style="border-radius: 20px">
        <ul class="nav nav-pills justify-content-md-start mt-2 border-bottom justify-content-sm-around" id="pills-tab"
            ...
            <li class="nav-item p-2 flex-fill text-center">
                <a class="nav-link active" id="pills-tambah-alamat-baru-tab" data-toggle="pill"
                    href="#pills-tambah-alamat-baru" role="tab" aria-controls="pills-tambah-alamat-baru"
                    aria-selected="true">Tambah Alamat Baru</a>
            </li>
            <li class="nav-item p-2 flex-fill text-center">
                <a class="nav-link" id="pills-daftar-alamat-tab" data-toggle="pill" href="#pills-daftar-alamat" role="tab"
                    aria-controls="pills-daftar-alamat" aria-selected="false">Daftar Alamat</a>
            </li>
        </ul>

        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-tambah-alamat-baru" role="tabpanel"
                aria-labelledby="pills-tambah-alamat-baru-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" class="form-control" id="no_hp_alamat" placeholder=""
                                                name="no_hp_alamat" style="border-radius: 10px" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap">
                                            <select name="provinsi_alamat" id="provinsi_alamat" class="form-control"
                                                style="border-radius: 10px" required>
                                                <option class="form-control" value="" id="prov__coba">Pilih Provinsi
                                                </option>
                                                @foreach ($provinsi as $info)
                                                    <option style="border-radius: 10px" value="{{ $info['id'] }}">
                                                        {{ $info['nama'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap">
                                            <select name="kota_kabupaten_alamat" id="" class="form-control"
                                                style="border-radius: 10px" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap">
                                            <select name="kecamatan_alamat" id="" class="form-control"
                                                style="border-radius: 10px" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap">
                                            <select name="kode_pos_alamat" id="" class="form-control"
                                                style="border-radius: 10px" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" type="text" id="alamat_alamat"
                                            name="alamat_alamat" placeholder="" style="border-radius: 10px"
                                            required></textarea>
            ...
            <div class="tab-pane fade show" id="pills-daftar-alamat" role="tabpanel"
                aria-labelledby="pills-daftar-alamat-tab">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-5 col-md-5 col-sm-5">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModal" name="edit_alamat" value="{{ $item->id }}"
                                    data-whatever="@mdo">
                                    Ubah
                                </button>
                            </div>
                            <div class="col-5 col-md-5 col-sm-5">
                                <a href="#" name="hapusalamat" value="{{ $item->id }}" type="button"
                ...
                if (cityID) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="kecamatan_alamat"]').append(
                ...
                if (subdistrictID) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="kode_pos_alamat"]').append(
                                '<option selected="true" disabled="disabled">Pilih Kode Pos</option>'
                                );
                            $.each(data, function(key, value) {
                                $('select[name="kode_pos_alamat"]').append(
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('#id_alamat_edit').replaceWith(
                                    ...
                                    data.alamat.id + '">');
                                $('#nama_edit').replaceWith(
                                    '<input type="text" class="form-control" id="nama_edit" name="nama_edit" required value="' +
                                    data.alamat.nama + '">');
                                $('#no_hp_edit').replaceWith(
                                    '<input type="text" class="form-control" id="no_hp_edit" name="no_hp_edit" required value="' +
                                    data.alamat.no_hp + '">');
                                $('#prov_coba').replaceWith('<option value="' + data
                                ...
                                $('#kec_coba').replaceWith('<option value="' + data
                                    ...
                                    .kecamatan + '</option>');
                                $('#kode_pos_coba').replaceWith('<option value="' + data
                                    .alamat.kode_pos + '" id="kode_pos_coba">' +
                                    data.alamat.kode_pos + '</option>');
                                $('#alamat_edit').replaceWith(
                                    '<textarea class="form-control" id="alamat_edit" name="alamat_edit" required>' +
                                    data.alamat.address + '</textarea>');
                ...
                if (cityID) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="kecamatan_edit"]').append(
                                '<option selected="true" disabled="disabled">Pilih Kecamatan</option>'
                                );
                            $.each(data, function(key, value) {
                                $('select[name="kecamatan_edit"]').append(
                ...
                if (subdistrictID) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="kode_pos_edit"]').append(
                                '<option selected="true" disabled="disabled">Pilih Kode Pos</option>'
                                );
                            $.each(data, function(key, value) {
                                $('select[name="kode_pos_edit"]').append(
