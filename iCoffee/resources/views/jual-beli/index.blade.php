...
@endsection
@section('content')
    <div class="hero-wrap hero-bread" style="background-image: url('blend_es.JPG');">
      <div class="container">
    	...
    	<div class="container">
    		...
    		<div class="row">
    			...
    			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 ftco-animate">
    				<div class="product">
    					<a href="/jual-beli/produk/{{ $data->slug }}" class="img-prod rounded"><img class="img-fluid" src="{{ url('/Uploads/Produk/{'.$data->kode_produk.'}/'.$data->gambar) }}" alt="Colorlib Template">
