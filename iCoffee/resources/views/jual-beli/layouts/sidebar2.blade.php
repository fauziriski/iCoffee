  ...
  <script>
      $(document).ready(function() {
        $('#menu-1').click(function() {
              $(this).find('i[id="icons-1"]').toggleClass('fas fa-chevron-down').toggleClass('fas fa-chevron-right');
        });
        $('#menu-2').click(function() {
            $(this).find('i[id="icons-2"]').toggleClass('fas fa-chevron-down').toggleClass('fas fa-chevron-right');
        });
        $('#menu-3').click(function() {
            $(this).find('i[id="icons-3"]').toggleClass('fas fa-chevron-down').toggleClass('fas fa-chevron-right');
        });
        $('#menu-4').click(function() {
            $(this).find('i[id="icons-4"]').toggleClass('fas fa-chevron-down').toggleClass('fas fa-chevron-right');
        });
                        ...
                        <nav class="navbar navbar-expand navbar-primary border flex-md-column flex-row align-items-start py-2" style="border-radius: 20px">
                            <div class="collapse navbar-collapse ">
                                <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-around">
                                    <li class="nav-item">
                                        <a class="nav-link pl-0 text-nowrap" id="menu-1" data-toggle="collapse" href="#submenu-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link pl-0 text-nowrap" id="menu-2" data-toggle="collapse" href="#submenu-2">
                                    ...
                                    <li class="nav-item has-treeview">
                                        <a class="nav-link pl-0" data-toggle="collapse" id="menu-3" href="#submenu-3">
                                            ...
                                            <span class="font-weight-bold d-none d-md-inline">Jual Beli &nbsp 
                                                ...
                                                &nbsp;<span class="badge badge-pill badge-success py-1 align-middle">{{ $count_order['count_order_produk'] }}</span>
                                                @endif 
                                            </span>
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link pl-0" data-toggle="collapse" id="menu-4" href="#submenu-4">
                                            ...
                                            <span class="font-weight-bold d-none d-md-inline">Lelang &nbsp 
                                                ...
                                                &nbsp;<span class="badge badge-pill badge-success py-1 align-middle">{{ $count_order['count_order_lelang'] }}</span>
                                                @endif 
                                            </span>
                                        </a>
