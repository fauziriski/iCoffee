                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="harga" class="form-control" placeholder="Min : 1000"
                                        value="{{ number_format($produk->harga, 0, ',', '.') }}" min="1000" name="harga"
                                        required>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="stok" placeholder="Contoh : 10" min="1"
                                        name="stok" value="{{ number_format($produk->stok, 0, ',', '.') }}" required>
                                    <div class="input-group-prepend">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="summernote" class="form-control" rows="5" type="text" name="detail_produk"
                                    required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image-{{ $i }}"
                                            id="inputGroupFile{{ $i }}" />
                                        <label class="custom-file-label" for="inputGroupFile{{ $i }}">Upload Foto
                                            Produk</label>
                                    </div>
                                </div>
                            </div>
