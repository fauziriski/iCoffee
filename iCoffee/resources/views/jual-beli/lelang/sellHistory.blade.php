                        ...
                        <div class="col-md-12 justify-content-center">
                            ...
                            <div class="row border mt-1 justify-content-around">
                                ...
                                <div class="col-md-3 align-self-center">
                                    ...
                                    <p class="font-weight-bold" style="color:  #ee4d2c">Rp {{ number_format($value->sub_total,0,",",".") }}</p>
                                </div>
                            ...
                            <div class="row mt-1 mb-1">
                                <div class="col-md-12 text-center ">
                                    <a href="/lelang/invoice_penjual/{{ $value->invoice }}"><span class="oi oi-eye"></span>&nbsp; Detail Pesanan </a>
                                </div>
                            </div>
                        </div>
                    </div>
