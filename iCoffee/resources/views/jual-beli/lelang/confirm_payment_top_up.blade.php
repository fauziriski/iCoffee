        ...
        <div class="card">
            <article class="card-group-item">
                <header class="card-header">
                    <h6 class="title">Konfirmasi Pembayaran</h6>
                </header>
                <form action="/profile/konfirmasi/top_up/berhasil" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-end mt-2 pl-4 pr-4 mb-5">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="" placeholder=""
                                                name="nama_bank_pengirim" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" class="form-control" id="" placeholder=""
                                                name="no_rekening_pengirim" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" class="form-control" id="" placeholder="" name="no_telp"
                                                required>
                                        ...
                                        <div class="input-group">
                                            <select name="invoice" id="" class="form-control" required>
                                                ...
                                                @foreach ($transaksipenjual as $data)
                                                    ...
                                                    <option class="form-control" value="{{ $data->invoice }}">
                                                        #{{ $data->invoice }}/{{ $data_tanggal }} </option>
                        ...
                        <div class="col-md-12 mt-3">
                            <button type="submit" class="btn btn-primary float-right py-3 px-4">Konfirmasi
                                Pembayaran</button>
                        </div>
