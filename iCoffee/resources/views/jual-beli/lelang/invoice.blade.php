                    ...
                    <form action="/lelang/pesanan/selesai" method="post" enctype="multipart/form-data">
                        ...
                        <p class="row justify-content-end ">
                            ...
                            <input type="submit" style="border-radius: 10px"
                                ...
                                value="Komplain">
                            <input type="submit" class="btn btn-primary py-3 px-5 mt-1 mr-1 ml-1 col-md-3" name="submit"
                                value="Diterima">
                        </p>
                    </form>
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <form action="" id="rating_form" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id_lelang_rating" id="id_order_rating" required
                                                value="{{ $order->id }}">
                                            <div class="row">
                                                <div class="col-lg-12">
