                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="harga_awal" class="form-control" placeholder="Contoh : 100.000"
                                        min="10000" name="harga_awal" required>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="kelipatan" class="form-control" placeholder="Contoh : 1.000"
                                        min="1000" name="kelipatan" required>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="stok" class="form-control" id="" placeholder="Satuan" name="stok"
                                        min="10" max="100" required>
                                    <div class="input-group-prepend">
                                        <div style="border-top-right-radius: 10px; border-bottom-right-radius: 10px;"
                                            class="input-group-text">Kg</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summernote" rows="5" type="text" name="deskripsi"
                                    required></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="image-{{ $item }}"
                                            id="inputGroupFile{{ $item }}" />
                                        <label class="custom-file-label" for="inputGroupFile{{ $item }}">Upload Foto
                                            Produk</label>
                                    </div>
                                </div>
                            </div>
