...
@section('content')
              ...
              <div class="col-lg-6 mb-1 ftco-animate">
                <div class="row">
                  <div class="col-md-12 text-center border-bottom">
                    {{-- <img class="img-fluid rounded" src="{{ asset('Uploads/Produk/{'.$dataa->kode_produk.'}/'.$dataa->gambar) }}" alt="Colorlib Template"> --}}
                    <a style="" href="{{ asset('Uploads/Produk/{'.$dataa->kode_produk.'}/'.$dataa->gambar) }}" class="image-popup"><img class="img-fluid rounded" src="{{ asset('Uploads/Produk/{'.$dataa->kode_produk.'}/'.$dataa->gambar) }}" class="img-fluid" alt="Colorlib Template">
                    </a>
                  </div>
                  <div class="col-md-12 mt-2">
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-3 col-3 ftco-animate">
                          <div class="product">
                            <a href="{{ asset('Uploads/Produk/{'.$dataa->kode_produk.'}/'.$data->nama_gambar) }}" class="image-popup"><img class="img-fluid rounded border" src="{{ asset('Uploads/Produk/{'.$dataa->kode_produk.'}/'.$data->nama_gambar) }}" alt="Colorlib Template">
                              <div class="overlay"></div>
                            </a>
                          </div>
                        </div>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
            ...
            <div class="product">
              <a href="/jual-beli/produk/{{ $data->slug }}" class="img-prod"><img class="img-fluid rounded" src="{{ url('/Uploads/Produk/{'.$data->kode_produk.'}/'.$data->gambar) }}" alt="Colorlib Template">
                <div class="overlay"></div>
              </a>
