                                ...
                                <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-around">
                                    <li class="nav-item">
                                        <a class="nav-link pl-0 text-nowrap" data-toggle="collapse" href="#submenu-1">
                                            <i class="fas fa-id-card fa-fw"></i> <span
                                                class="font-weight-bold d-none d-md-inline"> Profile</span>
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link pl-0 text-nowrap" data-toggle="collapse" href="#submenu-2">
                                            <i class="fas fa-money-check-alt fa-fw"></i> <span
                                                class="font-weight-bold d-none d-md-inline"> Top Up</span>
                                        </a>
                                        <ul id="submenu-2" class="panel-collapse collapse panel-switch pl-0"
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#"><i
                                                        class="fas fa-handshake"></i> Konfirmasi Top Up</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link pl-0" data-toggle="collapse" href="#submenu-3">
                                            <i class="fas fa-store-alt fa-fw"></i> <span
                                                class="font-weight-bold d-none d-md-inline">Jual Beli</span>
                                        </a>
                                        <ul id="submenu-3" class="panel-collapse collapse panel-switch pl-0"
                                            role="menu">
                                            <li class="nav-item"><a class="nav-link" href="#"><i
                                                        class="fas fa-history"></i> Riwayat Penjualan</a></li>
                                            <li class="nav-item"><a class="nav-link" href="#"><i
                                                        class="fas fa-store-alt"></i> Produk Anda</a></li>
                                            <li class="nav-item"><a class="nav-link" href="#"><i
                                                        class="fas fa-history"></i> Riwayat Pembelian</a></li>
                                            <li class="nav-item"><a class="nav-link" href="#"><i
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link pl-0" data-toggle="collapse" href="#submenu-4">
                                            <i class="fas fa-stopwatch fa-fw"></i> <span
                                                class="font-weight-bold d-none d-md-inline">Lelang</span>
                                        </a>
