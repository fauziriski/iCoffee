...
@section('content')
                ...
                <main class="col bg-faded py-1 border flex-grow-1 mt-2" style="border-radius: 20px">
                    <ul class="nav nav-pills justify-content-md-start mt-2 border-bottom justify-content-sm-around" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item p-2 flex-fill text-center">
                            <a class="nav-link" id="pills-edit-password-tab" data-toggle="pill" href="#pills-edit-password" role="tab" aria-controls="pills-edit-password" aria-selected="false">Edit Password</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="email"  class="form-control" placeholder="" name="email" required value="{{ $user->email }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" class="form-control" id="" placeholder="" name="password" required value="">
                        ...
                        <div class="tab-pane fade show" id="pills-edit-password" role="tabpanel" aria-labelledby="pills-edit-password-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" style="border-radius: 10px" class="form-control" id="" placeholder="" name="password_lama" required value="">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password"  style="border-radius: 10px" class="form-control" id="" placeholder="" name="password_baru" required value="">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" style="border-radius: 10px"  class="form-control" id="" placeholder="" name="cek_password_baru" required value="">
