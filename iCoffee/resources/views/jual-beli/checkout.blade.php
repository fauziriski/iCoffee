                                ...
                                <div class="form-group">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <p><a href="/profile/alamat#pills-daftar-alamat" style="border-radius: 10px"
                                                    class="btn btn-primary py-3 px-4 align-self-end">Ganti Alamat</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table class="table table-condensed">
                                                    ...
                                                    <tbody>
                                                        @for ($j = 0; $j < $jumlah_data_checkout[$i]; $j++)
                                                            <tr class="text-center">
                                                                <td class="image-prod">
                                                                    <img src="{{ asset('Uploads/Produk/' . $checkout_data[$i][$j]->kode_produk . '/' . $checkout_data[$i][$j]->image) }}"
                                                                ...
                                                                <td class="price">Rp
                                                                    {{ number_format($checkout_data[$i][$j]->harga, 0, ',', '.') }}
                                                                </td>
                                                                <td class="total">{{ $checkout_data[$i][$j]->jumlah }}</td>
                                                                <td class="total">Rp
                                                                    {{ number_format($checkout_data[$i][$j]->total, 0, ',', '.') }}
                                                                </td>
                                                            </tr><!-- END TR-->
                                                            <input type="hidden" name="id_keranjang[]"
                                                                value="{{ $checkout_data[$i][$j]->id }}">
                                                            <input type="hidden" name="id_produk[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->id_produk }}">
                                                            <input type="hidden" name="id_penjual[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->id_penjual }}">
                                                            <input type="hidden" name="harga[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->harga }}">
                                                            <input type="hidden" name="jumlah[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->jumlah }}">
                                                            <input type="hidden" name="nama_produk[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->nama_produk }}">
                                                            <input type="hidden" name="kode_produk[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->kode_produk }}">
                                                            <input type="hidden" name="gambar[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->image }}">
                                                            <input type="hidden" name="total[{{ $i }}][{{ $j }}]"
                                                                value="{{ $checkout_data[$i][$j]->total }}">
                                        ...
                                        <div class="col-md-6 p-2 p-md-4">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" type="text" name="pesan[]"
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap">
                                                            <select name="kurir[{{ $i }}]" id="kurir{{ $penjual[$i]->id }}"
                                                                class="kurir form-control" required>
                                                                {{-- onchange="myFunction()"
                                                                --}}
                                                                ...
                                                                {{-- @for ($k = 0; $k < count($costjne[$i]['rajaongkir']['results'][0]['costs']); $k++)
                                                                    <option
                                                                        ...
                                                                        JNE Rp
                                                                        {{ number_format($costjne[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'], 0, ',', '.') }}
                                                                        (
                                                                        {{ $costjne[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}
                                                                ...
                                                                @for ($k = 0; $k < count($costtiki[$i]['rajaongkir']['results'][0]['costs']); $k++)
                                                                    <option
                                                                        value="{{ $costtiki[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'] }}: TIKI: {{ $costtiki[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}">
                                                                        TIKI Rp
                                                                        {{ number_format($costtiki[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'], 0, ',', '.') }}
                                                                        (
                                                                        {{ $costtiki[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}
                                                                        {{ $costtiki[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['etd'] }}
                                                                        Hari )
                                                                    </option>
                                                                @endfor
                                                                ...
                                                                @for ($k = 0; $k < count($costjnt[$i]['rajaongkir']['results'][0]['costs']); $k++)
                                                                    <option
                                                                        value="{{ $costjnt[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'] }}: JNT: {{ $costjnt[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}">
                                                                        J&T Rp
                                                                        {{ number_format($costjnt[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'], 0, ',', '.') }}
                                                                        (
                                                                        {{ $costjnt[$i]['rajaongkir']['results'][0]['costs'][$k]['description'] }}
                                                                        {{ $costjnt[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['etd'] }}
                                                                        )
                                                                    </option>
                                                                @endfor
                                                                ...
                                                                @for ($k = 0; $k < count($costninja[$i]['rajaongkir']['results'][0]['costs']); $k++)
                                                                    <option
                                                                        value="{{ $costninja[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'] }}: Ninja: {{ $costninja[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}">
                                                                        Ninja Rp
                                                                        {{ number_format($costninja[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['value'], 0, ',', '.') }}
                                                                        (
                                                                        {{ $costninja[$i]['rajaongkir']['results'][0]['costs'][$k]['service'] }}
                                                                        {{ $costninja[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['etd'] }}
                                                                        )
                                                                    </option>
                                                                @endfor
                                                                ...
                                                                @for ($k = 0; $k < count($costlion[$i]['rajaongkir']['results'][0]['costs']); $k++)
                                                                    <option
                                                                        ...
                                                                        {{ $costlion[$i]['rajaongkir']['results'][0]['costs'][$k]['cost'][0]['etd'] }}
                                                                        )
                                                                    </option>
                                                                @endfor
                                                ...
                                                <div class="col-md-12 p-1 p-md-3">
                                                    ...
                                                    <div class="cart-detail">
                                                        ...
                                                        <h6 class="text-center mt-1">Total Pembayaran Rp.
                                                            {{ number_format($jumlah[$i], 0, ',', '.') }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-7 mt-5 cart-wrap ftco-animate">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col text-center col-12 offset-md-8 mb-5">
                                            ...
                                            --}}
                                            <p><input type="submit" style="border-radius: 10px"
                                                    class="btn btn-primary py-3 px-4" value="Buat Pesanan"></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
