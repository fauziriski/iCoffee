...
@section('title', 'Admin | Mitra Kelompok Tani')
...
<body id="page-top">
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Validasi Mitra Kelompok Tani</h1>
		</div>
					...
					<div class="form-group">
						...
						<div class="table-responsive">
							<table cellpadding="10" border="0">
								<tr>
									<div class="form-group">
										<th width="15%" style="text-align: right;">Foto Mitra&nbsp;&nbsp;&nbsp;:</th>		
										<th width="25%">
											<div id="image">
											...
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">Nama Kelompok&nbsp;&nbsp;&nbsp;:</th>	
													<th width="25%"><a id="nama_kelompok"></a></th>

												</div>
											</tr>
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">Jumlah Petani&nbsp;&nbsp;&nbsp;:</th>	
											...
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">Email Mitra&nbsp;&nbsp;&nbsp;:</th>	
											...
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">No Telepon&nbsp;&nbsp;&nbsp;:</th>	
											...
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">Alamat Mitra&nbsp;&nbsp;&nbsp;:</th>	
											...
											<tr>
												<div class="form-group">
													<th width="15%" style="text-align: right;">Deskripsi&nbsp;&nbsp;&nbsp;:</th>	
			...
			<script>
				$(document).ready(function(){
					$('#table_id').DataTable({
						...
						ajax: '{{ route('admin.kelompok-tani') }}',
					...
					$(document).on('click', '.lihat', function(){
						var id = $(this).attr('id');
						$.ajax({
							url:"validasi-kelompok/"+id,
							dataType:"json",
							success:function(html){

								$('#modalLihat').modal('show');
								$('.modal-title').text("Detail Mitra");
								document.getElementById("nama_kelompok").innerHTML = html.data.nama_kelompok;
					...
					$(document).on('click', '.verifikasi', function(){
						...
						$.ajax({
							...
							success:function(html){
								...
								$('#nama_koperasi2').val(html.data.nama_kelompok);
					...
					$('#sample_form').on('submit', function(event){
						...
						{
							$.ajax({
								url:"{{ route('admin.tolak-kelompok.update') }}",
								method:"POST",
						...
						{
							$.ajax({
								url:"{{ route('admin.validasi-petani.kelompok') }}",
								method:"POST",
								data: new FormData(this),
								contentType: false,
								cache:false,
