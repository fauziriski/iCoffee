...
@section('title', 'Admin | Validasi Pencairan Dana Mitra')
...
<body id="page-top">
    ...
    <div class="card shadow mb-4">
        ...
        <div
            ...
            <h5>Validasi Pencairan Saldo Mitra</h5>
        </div>
        <!-- Card Body -->
        <div class="card-body">
					...
					<div class="row">
						<div class="table-responsive col-md-12">
							<table cellpadding="10" border="0">
								...
								<tr>
									<div class="form-group">
										<th width="35%" style="text-align: right;">Kode Mitra&nbsp;&nbsp;&nbsp;:</th>	
...
<script>
	$(document).ready(function(){
		$('#table_id').DataTable({
			...
			ajax: '{{ route('admin.validasi-pencairan-mitra') }}',
		...
		$(document).on('click', '.lihat', function(){
			var id = $(this).attr('id');
			$.ajax({
				url:"lihat-validasi-pencairan-mitra/"+id,
				dataType:"json",
				success:function(html){

					var rp = html.data.jumlah;
					var saldoo = html.mitra.saldo;
					...
					document.getElementById("invoice").innerHTML = html.data.id_mitra;
					document.getElementById("pemilik_rekening").innerHTML = html.bank.name;
					document.getElementById("email").innerHTML = html.mitra.email;
					document.getElementById("no_rekening").innerHTML = html.bank.norek;
					document.getElementById("bank").innerHTML = html.bank.bank_name;
		...
		$('#sample_form').on('submit', function(event){
			...
			{
				$.ajax({
					url:"{{ route('admin.tolak-pencairan-mitra.update') }}",
					method:"POST",
			...
			{
				$.ajax({
					url:"{{ route('admin.validasi-pencairan-mitra.update') }}",
					method:"POST",
					data: new FormData(this),
					contentType: false,
					cache:false,
