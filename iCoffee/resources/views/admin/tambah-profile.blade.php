		...
		<div class="card shadow mb-4">
			...
			<div class="card-body mb-5">
				<div class="container-fluid mt-5">
					<div class="row">
						<div class="col-md-6">
						<form action="{{ route('admin.profile.tambah') }}" enctype="multipart/form-data" method="POST">
								@csrf
					...
					<div class="col-md-6">
						<form action="{{ route('admin.profile2.update') }}" enctype="multipart/form-data" method="POST">
							@csrf
							<div class="container">
							<div class="table-responsive">
							<table cellpadding="10" border="0">
