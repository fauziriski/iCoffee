...
@section('title', 'Admin Keuangan | Pencairan lelang')
...
<body id="page-top">
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Pencairan Dana Lelang</h1>
		</div>
					...
					<script>
						$(document).ready(function(){
							...
							$('#id_tabel').DataTable({
								...
								serverSide: true,
								ajax:{
									url: "{{ route('adminkeuangan.setor-lelang') }}",
									dataType:"json",
								},
								columns:[
							...
							$('#sample_form').on('submit', function(event){
								...
								{
									$.ajax({
										url:"{{ route('adminkeuangan.tambah-pelelang') }}",
										method:"POST",
								...
								{
									$.ajax({
										url:"{{ route('adminkeuangan.update-pelelang') }}",
										method:"POST",
										data: new FormData(this),
										contentType: false,
										cache:false,
							...
							$(document).on('click', '.lihat', function(){
								...
								$.ajax({
									...
									success:function(html){
										...
										var img = "/Uploads/Adm_bukti/AKKL/" + html.data.bukti  +"";
										$('#bukti2').attr("src",img);
