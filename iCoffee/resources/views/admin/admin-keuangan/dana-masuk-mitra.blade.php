...
@section('title', 'Admin Keuangan | Kas Masuk Mitra')
					...
					<script>
						$(document).ready(function(){
							...
							},
							{
								...
								serverSide: true,
								ajax:{
									url: "{{ route('adminkeuangan.dana-masuk-mitra') }}",
									dataType:"json",
								},
								columns:[
							...
							$(document).on('click', '.lihat', function(){
								var id = $(this).attr('id');
								$.ajax({
									url:"detail-dana-masuk-mitra/"+id,
									dataType:"json",
