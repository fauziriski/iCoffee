			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="order_table" class="table table-striped table-bordered" border="0" style="width:100%">
						...
						<tfoot>
								<tr>
									<th colspan="2" style="text-align:right">TOTAL JUMLAH SEIMBANG:</th>
									<th></th>
									<th></th>
								</tr>
						</tfoot>
				...
				<script>
					...
					$('#order_table').DataTable({
						"footerCallback" : function (row, data, start, end, display) {
							...
							serverSide: true,
							ajax: {
								url:'{{ route("adminkeuangan.neraca-saldo.index") }}',
								data:{from_date:from_date, to_date:to_date}
							},
							columns: [
								{data: 'no_akun', name:'no_akun'},
								{data: 'nama_akun', name: 'nama_akun'},
								{data: 'total_debit', name:'total_debit', render: $.fn.dataTable.render.number( '\,', '.', 0, 'Rp ' ).display},
								{data: 'total_kredit', name:'total_kredit', render: $.fn.dataTable.render.number( '\,', '.', 0, 'Rp ' ).display}
							]
							});
							}
