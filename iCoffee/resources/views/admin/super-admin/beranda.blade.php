...
@section('title', 'Admin Super | Beranda')
		...
		<div class="col-xl-4 col-lg-7">
				<div class="card shadow mb-4">
					...
					<div class="text-center small">
							<span class="mr-2">
								<i class="fas fa-circle" style="color:blue"></i> Total Pengguna {{$total}}
							</span><br><br>
						</div>
				</div>
			</div>
			...
			<div class="col-xl-4 col-lg-7">
				<div class="card shadow mb-4">
					...
					<div class="text-center small">
							<span class="mr-2">
								<i class="fas fa-circle" style="color:blue"></i> Total Produk {{$total_produk}}
							</span><br><br>
						</div>
				</div>
			</div>
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: ['#FFA500', '#36b9cc', '#1cc88a'], 
      hoverBackgroundColor: ['#FF8C00', '#2c9faf', '#17a673'], 
...
var myPieChart = new Chart(ctx, {
  type: 'pie',
  data: {
    labels: <?php echo json_encode($kategori2); ?>,
    datasets: [{
      data: <?php echo json_encode($data2); ?>,
      backgroundColor: ['#66CDAA', '#48D1CC', '#FFD700'], 
      hoverBackgroundColor: ['#3CB371', '#00CED1', '#DAA520'], 
      hoverBorderColor: "rgba(234, 236, 244, 1)",
    }],
