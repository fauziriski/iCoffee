...
<body id="page-top">
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h5 class="h3 mb-0 text-gray-800">Validasi Pembayaran Lelang</h5>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
					...
					<input type="text" name="nama_pemilik_pengirim2" id="nama_pemilik_pengirim2" />
					<input type="text" name="foto_bukti2" id="foto_bukti2" />
					<input type="text" name="jumlah_transfer2" id="jumlah_transfer2" />
					<div class="text2">
