	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm"><i class="fa fa-plus-square"></i> Tambah Admin</button>
			</div>
			<!-- Card Body -->
			<div class="card-body">
                ...
                <form
					...
					<table cellpadding="10" border="0">
						<tr>
								...
								<th width="12%" style="text-align: right;">Nama Admin&nbsp;&nbsp;&nbsp;:</th>	
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<div class="form-group">
							<table cellpadding="10" border="0">
							<tr>
							<th width="13%" style="text-align: right;">Foto&nbsp;&nbsp;&nbsp;:</th>		
										<th width="25%">
											<div id="image">
								...
								<tr>
									<div class="form-group">
										<th width="13%" style="text-align: right;">Nama&nbsp;&nbsp;&nbsp;:</th>	
										<th width="25%"><a id="nama"></a></th>
									</div>	
								</tr>
								<tr>
									<div class="form-group">
										<th width="13%" style="text-align: right;">Role&nbsp;&nbsp;&nbsp;:</th>	
										<th width="25%"><a id="role"></a></th>
									</div>	
								</tr>
								<tr>
									<div class="form-group">
...
$(document).on('click', '.lihat', function () {
    ...
    $.ajax({
        ...
        success: function (html) {
            ...
            $('.modal-title').text("Detail Admin");
			document.getElementById("nama").innerHTML = html.get.name;
			document.getElementById("no_hp").innerHTML = html.data.no_hp;
			document.getElementById("alamat").innerHTML = html.data.alamat;
			document.getElementById("role").innerHTML = html.role;
			document.getElementById("foto").innerHTML = html.data.foto;

			
			var img = "/Uploads/" + html.data.foto +"";
			$('#foto').attr("src",img);
