...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/open-iconic-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/animate.css') }}">
    
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/magnific-popup.css') }}">

    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/aos.css') }}">

    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/ionicons.min.css') }}">

    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/jquery.timepicker.css') }}">

    
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{asset('Jualbeli/Backup/css/style.css') }}">
  </head>
